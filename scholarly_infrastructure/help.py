...
# %% ../src/notebooks/00_help (library information).ipynb #f3525738
# https://stackoverflow.com/questions/1547466/check-if-a-parameter-is-a-python-module
from types import ModuleType

# %% ../src/notebooks/00_help (library information).ipynb #9e87483b
...
# %% ../src/notebooks/00_help (library information).ipynb #84769ae5
import scholarly_infrastructure as this_library

lib_paths = setup_paths(this_library)

# %% ../src/notebooks/00_help (library information).ipynb #a0a5eae2
...
# %% ../src/notebooks/00_help (library information).ipynb #8727b533
create_variables_from_dict(lib_paths)


# %% ../src/notebooks/00_help (library information).ipynb #8cd70603
def combine_bilingual_pretty(primary: str, auxiliary: str) -> str:
    return f"{primary} ({auxiliary}) "


# %% ../src/notebooks/00_help (library information).ipynb #9d1f3125
