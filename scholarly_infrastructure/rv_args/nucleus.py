...
# %% ../../src/notebooks/01_rv_args (arguments are random variables).ipynb #1afc8855
...
# %% ../../src/notebooks/01_rv_args (arguments are random variables).ipynb #296fcf2a
...
# %% ../../src/notebooks/01_rv_args (arguments are random variables).ipynb #174631e1
...
# %% ../../src/notebooks/01_rv_args (arguments are random variables).ipynb #0672a862
from copy import deepcopy
...
# %% ../../src/notebooks/01_rv_args (arguments are random variables).ipynb #7906b22c
class DataClass:
    decorator = dataclass
...
# %% ../../src/notebooks/01_rv_args (arguments are random variables).ipynb #91eae0c1
@decorator
...
# %% ../../src/notebooks/01_rv_args (arguments are random variables).ipynb #d1a13766
...
# %% ../../src/notebooks/01_rv_args (arguments are random variables).ipynb #78f067d0
_experiment_module = dataclass_for_torch_decorator(
    experiment_setting
)  # 隐藏，不建议直接使用

# %% ../../src/notebooks/01_rv_args (arguments are random variables).ipynb #7f7d1fd1
import torch
